package org.eop.sb.security.metadatasource;
...
import org.eop.sb.security.metadata.FilterInvocationSecurityMetadataLoader;
...
public class DatabaseFilterInvocationSecurityMetadataSource implements FilterInvocationSecurityMetadataSource,
			FilterInvocationSecurityMetadataLoader {
	...
	@Override
	public void load() {
		lastModified = metadataService.getLastModified();
		lastLoaded = new Date();
	...
	private LinkedHashMap<RequestMatcher, Collection<ConfigAttribute>> loadRequestMap() {
		LinkedHashMap<String, List<String>> urlRolesMappings = metadataService.getAllUrlRolesMappings();
